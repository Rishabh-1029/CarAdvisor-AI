        ...
        <div className="pdf-page pdf-page-break">
          ...
          <div className="pdf-content-area">
            ...
            <p className="pdf-disclaimer" style={{ marginTop: "12px", textAlign: "center" }}>
              Report auto-generated by TrueDrive AI on {formattedDate}. All estimates are for guidance only. Visit the official manufacturer website for accurate pricing.
            </p>
          </div>
          <Footer page={5} />
        </div>
